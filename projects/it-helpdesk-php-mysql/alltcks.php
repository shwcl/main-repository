...
<?php 
	...
	if ($no_pages > 1) {
		...
		If ($current_page != 1) {
			echo '<a href="alltcks.php?s=' . ($start - $display) . '&p=' . $no_pages . '">Previous</a> ';
		} 
		...
		for ($i = 1; $i <= $no_pages; $i++) {
			if ($i != $current_page) {
				...
				echo '<a href="alltcks.php?s=' . $display * ($i - 1) . '&p=' . $no_pages . '">' . $i . '</a> ';
		...
		If ($current_page != $no_pages) {
			echo '<a href="alltcks.php?s=' . ($start + $display) . '&p=' . $no_pages . '">Next</a> ';
